...
const nextConfig = {
	...
	async redirects() {
		return [
			// Static redirects (alphabetical for clarity)
			{ source: "/About/What-we-do/Evidence-Services/journals-and-databases", destination: "/library-and-knowledge-services", permanent: true },
			{ source: "/About/Who-we-are/Board/Board-expenses", destination: "/about-us/our-board/board-expenses", permanent: true },
			{ source: "/About/Who-we-are/Policies-and-procedures/NICE-equality-scheme", destination: "/about-us/policies-procedures-and-reports/edi-roadmap-and-annual-action-plan", permanent: true },
			{ source: "/aac", destination: "This is a redirect to: https://www.england.nhs.uk/aac/about-us/who-we-are/", permanent: true },
			{ source: "/about", destination: "/about-us", permanent: true },
			{ source: "/about/nice-communities/generalpractice", destination: "/get-involved/gps-and-primary-care", permanent: true },
			{ source: "/about/nice-communities/generalpractice/reference-panel", destination: "/forms/subscribe-to-our-gp-reference-panel", permanent: true },
			{ source: "/about/nice-communities/library-and-knowledge-services-staff/buy-books--journals-and-databases/organisations-eligible-to-use-the-framework", destination: "/library-and-knowledge-services/buy-books-journals-and-databases", permanent: true },
			{ source: "/about/nice-communities/library-and-knowledge-services-staff/buy-books--journals-and-databases/provider-information/sole-supplied-titles", destination: "/library-and-knowledge-services/buy-books-journals-and-databases/sole-supplied-titles", permanent: true },
			{ source: "/about/nice-communities/library-and-knowledge-services-staff/buy-books--journals-and-databases/purchasing-steps--direct-awards", destination: "/library-and-knowledge-services/buy-books-journals-and-databases/purchasing-steps-direct-awards", permanent: true },
			{ source: "/about/nice-communities/library-and-knowledge-services-staff/buy-books--journals-and-databases/purchasing-steps--further-competition", destination: "/library-and-knowledge-services/buy-books-journals-and-databases/purchasing-steps-further-competition", permanent: true },
			{ source: "/about/nice-communities/library-and-knowledge-services-staff/buy-books-journals-and-databases", destination: "/library-and-knowledge-services/buy-books-journals-and-databases", permanent: true },
			{ source: "/about/nice-communities/library-and-knowledge-services-staff/buy-books-journals-and-databases/provider-information", destination: "/library-and-knowledge-services/buy-books-journals-and-databases/provider-information", permanent: true },
			{ source: "/about/what-we-do/evidence-services/journals-and-databases/OpenAthens", destination: "/library-and-knowledge-services/openathens", permanent: true },
			{ source: "/about/what-we-do/evidence-services/journals-and-databases/openathens/access", destination: "/library-and-knowledge-services/openathens/openathens-access", permanent: true },
			{ source: "/about/what-we-do/evidence-services/journals-and-databases/openathens/openathens-eligibility", destination: "/library-and-knowledge-services/openathens/openathens-eligibility", permanent: true },
			{ source: "/about/what-we-do/evidence-services/journals-and-databases/openathens/openathens-registration-help", destination: "/library-and-knowledge-services/openathens/openathens-registration-help", permanent: true },
			{ source: "/about/what-we-do/evidence-services/journals-and-databases/openathens/openathens-support", destination: "/library-and-knowledge-services/openathens/openathens-support", permanent: true },
			{ source: "/bnf-uk-only", destination: "/bnf-via-nice-is-only-available-in-the-uk", permanent: true },
			{ source: "/bnfc-uk-only", destination: "/bnfc-via-nice-is-only-available-in-the-uk", permanent: true },
			{ source: "/cks-uk-only", destination: "/cks-is-only-available-in-the-uk", permanent: true },
			{ source: "/covid-19/rapid-c19", destination: "/rapid-c-19", permanent: true },
			{ source: "/forms/life-sciences-contact-us", destination: "/forms/nice-advice-contact-us", permanent: true },
			{ source: "/forms/request-for-prioritisation-clarification", destination: "Form", permanent: true },
			{ source: "/forms/topic-suggestion", destination: "Form", permanent: true },
			{ source: "/get-involved/careers", destination: "/careers", permanent: true },
			{ source: "/get-involved/careers/digital-at-nice", destination: "/careers/digital-at-nice", permanent: true },
			{ source: "/get-involved/careers/diversity-and-inclusion", destination: "/careers/diversity-and-inclusion", permanent: true },
			{ source: "/get-involved/careers/our-benefits--rewards-and-work-life-balance", destination: "/careers/our-benefits-rewards-and-work-life-balance", permanent: true },
			{ source: "/get-involved/careers/we-care-about-our-staff", destination: "/careers/we-care-about-our-staff", permanent: true },
			{ source: "/get-involved/contact-us", destination: "/contact-us", permanent: true },
			{ source: "/get-involved/jobs", destination: "/careers", permanent: true },
			{ source: "/get-involved/jobs/diversity-and-inclusion", destination: "/careers/diversity-and-inclusion", permanent: true },
			{ source: "/get-involved/jobs/our-benefits--rewards-and-work-life-balance", destination: "/careers/our-benefits-rewards-and-work-life-balance", permanent: true },
			{ source: "/get-involved/jobs/we-care-about-our-staff", destination: "/careers/we-care-about-our-staff", permanent: true },
			{ source: "/indicators", destination: "/indicators/published", permanent: true },
			// ... (other static redirects, sorted)

			// Parameterized and wildcard redirects (specific before general)
			{ source: "/standards-and-indicators/qofindicators/the-percentage-of-patients-with-cvd-who-are-currently-treated-with-a-lipid-lowering-therapy", destination: "/indicators/IND230-cardiovascular-disease-prevention-secondary-prevention-with-lipid-lowering-therapies", permanent: true },
			{ source: "/standards-and-indicators/qofindicators/the-percentage-of-patients-with-dementia-with-the-contact-details-of-a-named-carer-on-their-record", destination: "/indicators/IND114-dementia-named-carer", permanent: true },
			{ source: "/standards-and-indicators/qofindicators/:path*", destination: "/indicators/published", permanent: true },
			{ source: "/standards-and-indicators/gpqualityimprovements/:path*", destination: "/indicators/published", permanent: true },
			{ source: "/standards-and-indicators/ccgoisindicators/:path*", destination: "/indicators/published", permanent: true },
			{
			...
			{
				source: "/About/What-we-do/Our-Programmes/NICE-guidance/NICE-diagnostics-guidance",
			...
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/families-and-relationships-settings/involving-families-in-care-planning",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/families-and-relationships-settings/supporting-inter-generational-need",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/mental-health-services/managing-violence-and-aggression",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/mental-health-services/maintaining-contact-with-service-users",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/mental-health-services/advance-planning-and-psychiatric-inpatient-admission",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/learning-disability-settings/supporting-parents",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/learning-disability-settings/planning-for-the-future",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/learning-disability-settings/providing-end-of-life-care-and-support",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/services-for-older-people/discharging-people-from-hospital",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/services-for-older-people/taking-a-person-centred-approach-to-rehabilitation",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-in-social-work",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios/services-for-older-people/improving-wellbeing-in-care-homes",
				permanent: true,
			},
			{
				source:
					"/about/nice-communities/social-care/using-nice-guidance-principal-social-workers",
				destination:
					"/implementing-nice-guidance/social-care/using-nice-guidance-in-social-work-scenarios-for-principle-social-workers",
				permanent: true,
			},
			{
				source: "/about/nice-communities/medicines-and-prescribing",
			...
			{
				source: "/standards-and-indicators/quality-standards",
				destination: "/get-involved/help-develop-quality-standards",
				permanent: true,
			},
			{
				source:
			...
			},
			{
				source: "/aac",
				destination:
					"This is a redirect to: https://www.england.nhs.uk/aac/about-us/who-we-are/",
				permanent: true,
			},
			{
