	...
	describe("DocumentsHTMLPage", () => {
		...
		describe("Breadcrumbs", () => {
			it("should render parent breadcrumb linking to the project overview", () => {
				...
				).toHaveAttribute("href", "/hub/indevelopment/gid-ta10730");
			});
		...
		it("should render resource links ", () => {
			const mockResourceLinks = [
				{
					...
					href: "/hub/indevelopment/gid-ta10730/downloads/gid-ta10730-a-resource-file.pdf",
					fileTypeName: "PDF",
					fileSize: 168753,
				...
				},
				{
					...
					href: "/hub/indevelopment/gid-ta10730/downloads/gid-ta10730-another-resource-file.pdf",
					fileTypeName: "PDF",
					fileSize: 228170,
			...
			expect(resourceFile1).toHaveAttribute(
				"href",
				"/hub/indevelopment/gid-ta10730/downloads/gid-ta10730-a-resource-file.pdf"
			);

			expect(resourceFile2).toBeInTheDocument();
			expect(resourceFile2).toHaveAttribute(
				"href",
				"/hub/indevelopment/gid-ta10730/downloads/gid-ta10730-another-resource-file.pdf"
			);
		});
