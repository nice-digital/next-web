...
jest.mock("@nice-digital/search-client", () => {
	...
	const sampleData = require("@/mockData/search/guidance.json") as {
...
describe("Guidance sitemap XML", () => {
	it("should exclude withdrawn products and indicators from sitemap", async () => {
