...
import { IndevFile, getResourceFileHTML } from "@/feeds/inDev/inDev";
...
> = async ({ params, resolvedUrl, query }) => {
	...
	const resourceFileHTML = await getResourceFileHTML(
	...
	const resourceLinks: ResourceLinkViewModel[] = panel
		? arrayify(panel.embedded.niceIndevResourceList.embedded.niceIndevResource)
				...
				.map((resource) => {
					const { mimeType, length, resourceTitleId, fileName } = resource
							.embedded?.niceIndevFile as IndevFile,
