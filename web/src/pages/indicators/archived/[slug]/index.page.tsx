...
export type ArchivedDetailsPageProps = {
...
export default function ArchivedDetailsPage({
	indicatorSubTypes,
	pdfDownloadPath,
	product,
	productPath,
}: ArchivedDetailsPageProps): JSX.Element {
	...
	const downloadButtonText =
		type === "indicators" ? `archived indicator` : "archived";
	...
	return (
		<>
			...
			{/* archived doesn't use taxonomy, so no props passed in */}
			<GuidanceBreadcrumb
				id={product.id}
