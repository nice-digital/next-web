...
const expectedRobotsAllowedString = `User-agent: bingbot\nCrawl-delay: 1\nUser-agent: *\nDisallow: /forms/* Disallow: /bnfc-via-nice-is-only-available-in-the-uk Disallow: /bnf-via-nice-is-only-available-in-the-uk Disallow: /cks-is-only-available-in-the-uk Disallow: /cks-end-user-licence-agreement\nAllow: /`;
