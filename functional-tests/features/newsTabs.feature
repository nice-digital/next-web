Feature: News tabs
  ...
  Scenario: User can view news article tab
    ...
    And I expect that element ".simple-pagination" contains the text "Page 1 of 28"
  ...
  Scenario: User can view In-depth tab
    ...
    And I expect that element ".simple-pagination" contains the text "Page 1 of 4"
  ...
  Scenario: User can view blogs tab
    ...
    And I expect that element ".simple-pagination" contains the text "Page 1 of 9"
  ...
  Scenario: User can view blogs tab
    ...
    And I expect that element ".simple-pagination" contains the text "Page 1 of 3"
