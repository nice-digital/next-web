...
Scenario: User can view Latest articles sections
    ...
    And I expect that element "#__next > div > main > div.container > section:nth-child(3) > div > h2" contains the text "Latest articles"
    Then I click on the element "a[href='/news/articles']"
    Then I expect the url to contain "/news/articles"
    And I pause for 2000ms
  ...
  Scenario: User can view Latest in-depth sections
    ...
    Then I click on the element "a[href='/news/in-depth']"
    Then I expect the url to contain "/news/in-depth"
    And I pause for 2000ms
  ...
  Scenario: User can view Latest blogs sections
    ...
    Then I click on the element "a[href='/news/blogs']"
    Then I expect the url to contain "/news/blogs"
    And I pause for 2000ms
  ...
  Scenario: User can view Latest podcasts sections
    ...
    Then I click on the element "a[href='/news/podcasts']"
    And I pause for 2000ms
    Then I expect the url to contain "/news/podcasts"
