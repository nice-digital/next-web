Feature: The list of guidance list page is reduced when user filter by name
  ...
  Scenario: User can apply keyword filter published guidance list page
    ...
    Then I expect the result list count contains "Showing 1 to 10 of 39"
  ...
  Scenario: User can apply keyword filter topic selection list page
    ...
    Then I expect the result list count contains "Showing 1 to 9 of 9"
  ...
  Scenario: User can apply date filter
    ...
    Then I expect the result list count contains "Showing 1 to 10 of 55"
    Given I open the topic selection list page
    And I enter From date "02/02/2023" to filter page list
    Then I expect the result list count contains "Showing 1 to 2 of 2"
