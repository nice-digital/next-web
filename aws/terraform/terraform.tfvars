...
public_auth_environment = "#{PUBLIC_AUTH_ENVIRONMENT}"
public_base_url = "#{PUBLIC_BASE_URL}"
public_build_number = "#{PUBLIC_BUILD_NUMBER}"
santa_build_number = "#{SANTA_BUILD_NUMBER}"
public_environment = "#{PUBLIC_ENVIRONMENT}"
public_public_base_url = "#{PUBLIC_PUBLIC_BASE_URL}"
public_search_base_url = "#{PUBLIC_SEARCH_BASE_URL}"
public_storyblok_access_token = "#{PUBLIC_STORYBLOK_ACCESS_TOKEN}"
public_storyblok_enable_root_catch_all = "#{PUBLIC_STORYBLOK_ENABLE_ROOT_CATCH_ALL}"
public_storyblok_ocelot_endpoint = "#{PUBLIC_STORYBLOK_OCELOT_ENDPOINT}"
...
santa_both = "#{SANTA_BOTH}"
santa_tc = "#{SANTA_TC}"
santa_env = "#{SANTA_ENV}"
santa_none = "#{SANTA_NONE}"
next_public_santa_both = "#{NEXT_PUBLIC_SANTA_BOTH}"
next_public_santa_tc = "#{NEXT_PUBLIC_SANTA_TC}"
next_public_santa_env = "#{NEXT_PUBLIC_SANTA_ENV}"
next_public_santa_none = "#{NEXT_PUBLIC_SANTA_NONE}"
