...
export default function main() {
	...
	group("page_1 - https://alpha.nice.org.uk/guidance/published", function () {
		...
		sleep(12.2);
		response = http.get(
			"https://alpha-search-api.nice.org.uk/api/typeahead?index=nice&q=hyp",
			{
				headers: {
					"sec-ch-ua":
						'"Not A(Brand";v="99", "Google Chrome";v="121", "Chromium";v="121"',
		...
		response = http.get(
			"https://alpha-search-api.nice.org.uk/api/typeahead?index=nice&q=hype",
			{
				headers: {
					"sec-ch-ua":
						'"Not A(Brand";v="99", "Google Chrome";v="121", "Chromium";v="121"',
		...
		response = http.get(
			"https://alpha-search-api.nice.org.uk/api/typeahead?index=nice&q=hyper",
			{
				headers: {
					"sec-ch-ua":
						'"Not A(Brand";v="99", "Google Chrome";v="121", "Chromium";v="121"',
